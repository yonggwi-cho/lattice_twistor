...
module params
  ...
  integer,parameter :: Nt = 32  ! number of t spacetime's length
  integer,parameter :: Ns = 32  ! number of s spacetime's length
  ...
  real(8),parameter :: c1 = 1.0d0  ! constant value of t2
...
program main
  ...
  do n1 = 1, Nt
     do n3 = 1, Nt
        do m1 = 1, Ns
           do m2 = 1, Ns
              write(100,*) x(1,n1-1,n3-1,m1,m2),x(2,n1-1,n3-1,m1,m2),x(3,n1-1,n3-1,m1,m2)
           enddo
        enddo
     enddo
  enddo
